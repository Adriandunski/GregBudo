                ...
                <div className={'flex lg:flex-row flex-col xl:gap-8 gap-8 '}>
                    <div className={'basis-1/2 '}>
                        <InViewApear directory={'l'}>
                            <div className={'bg-orangeDark flex flex-col sm:p-8 p-8 relative overflow-hidden rounded-2xl  gap-8'}>
                        ...
                        <div className={'flex justify-between gap-3 sm:flex-row flex-col'}>
                            <TileContact topic={'Zadzwoń'} isDiff={false}>
                                ...
                                <Link className={'font-Jost font-light text-neutral-800'}
                                      href={'tel:+48667039013'}>667-039-013</Link>
                            </TileContact>
                            <TileContact topic={'Napisz'} isDiff={false}>
                                ...
                                <Link className={'font-Jost font-light text-neutral-800'}
                                      href={'mailto:kontakt@gregbudo.com'}>kontakt@gregbudo.com</Link>
