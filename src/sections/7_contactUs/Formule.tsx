    ...
    return(
        <form action={formAction} className={'flex flex-col gap-8'}>
            ...
            <div className={'flex flex-row items-start gap-5'}>
                <button type={'button'} className={'shrink-0 border-2 border-black px-2 py-1 rounded-md hover:cursor-pointer'} onClick={wybierzPlik}> Wybierz
                    pliki
                </button>
            ...
            <button type={'submit'} disabled={pending} className={'bg-orangeMain text-white py-4 rounded-3xl'}>Wyślij</button>
        </form>
    );
}
